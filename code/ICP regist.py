...
def warped_target_with_roi(mesh_dir,save_dir,ID, side,  sample_points_registration=100000):
    ...
    points2 += centroid_shift 
    
    # Perform ICP registration using the point clouds
    source_pcd = o3d.geometry.PointCloud()  
    source_pcd.points = o3d.utility.Vector3dVector(points2)  
    source_pcd.estimate_normals()  
    
    target_pcd = o3d.geometry.PointCloud()  
    target_pcd.points = o3d.utility.Vector3dVector(points1) 
    ...
    moving_mesh = o3d.geometry.TriangleMesh()  


    moving_mesh.vertices = o3d.utility.Vector3dVector(T2_condyle_img.vertices + centroid_shift)  
    moving_mesh.triangles = o3d.utility.Vector3iVector(T2_condyle_img.faces)  
